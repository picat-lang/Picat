...
void init_builtins(void) {
    ...
    INITIALIZE_BUILTIN1(23, b_RAND_MAX_f);
    ...
    INITIALIZE_BUILTIN4(46, b_GET_CLAUSES_cfff);
    INITIALIZE_BUILTIN2(47, b_ASSERTA_cc);
    ...
    INITIALIZE_BUILTIN2(79, b_ASSERTZ_cc);
    ...
    INITIALIZE_BUILTIN3(111, b_PLANNER_CURR_RPC_fff);
    ...
    INITIALIZE_BUILTIN1(126, b_IS_CALLABLE_c);
    INITIALIZE_BUILTIN3(127, b_INSERT_ORDERED_NO_DUP_ccf);
    INITIALIZE_BUILTIN3(128, b_INSERT_ORDERED_DOWN_NO_DUP_ccf);
    INITIALIZE_BUILTIN2(129, b_PICAT_PRINT_PRIMITIVE_cc);
    INITIALIZE_BUILTIN2(130, b_PICAT_WRITE_PRIMITIVE_cc);
    ...
    */
    ...
    INITIALIZE_BUILTIN3(272, b_ATOM_CONCAT_ccf);
    ...
    INITIALIZE_BUILTIN2(296, b_PICAT_LENGTH_cf);
